...
class ShopComponent extends Component
{
    ...
    public $pageSize = 12, $orderBy = "Default", $min_value = 0, $max_value = 1000;
    ...
    public function render()
    {
        ...
        return view('livewire.shop-component', ['products' => $products, 'categories' => $categories, 'min_value' => $this->min_value, 'max_value' => $this->max_value]);
