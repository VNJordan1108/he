...
{{-- @inject('cats_query', 'App\Models\Category') --}}
                ...
                <div class="header-wrap header-space-between position-relative">
                    ...
                    <div class="header-nav d-none d-lg-flex">
                        <div class="main-categori-wrap d-none d-lg-block">
                            ...
                            <div class="categori-dropdown-wrap categori-dropdown-active-large">
                                <ul>
                                    ...
                                    @php
                                        $i = 0;
                                        // $categories = $cats_query->orderBy('name', 'ASC')->get();
                                    @endphp
                        ...
                        <div class="main-menu main-menu-padding-1 main-menu-lh-2 d-none d-lg-block">
                            <nav>
                                <ul>
                                    <li><a class="{{Request::is('/')== True ? 'active' : ''}}" href="{{route('home.index')}}">Home </a></li>
                                    <li><a {{--class="{{Request::is('home')== True ? 'active' : ''}}"--}} href="about.html">About</a></li>
                                    <li><a class="{{Request::is('shop')== True ? 'active' : ''}}"href="{{route('shop')}}">Shop</a></li>
                                    ...
                                    @auth
                                            ...
                                            @else
                                            <li class="{{Request::is('user')== True ? 'active' : ''}}"><a href="#">My Account<i class="fi-rs-angle-down"></i></a>
                                                <ul class="sub-menu">
                ...
                <div class="row">
                    <div class="col-lg-4 col-md-6">
                        <div class="widget-about font-md mb-md-5 mb-lg-0">
                            ...
                            <p class="wow fadeIn animated">
                                <strong>Email: </strong> <a href="mailto:vnjordan1108@gmail.com">vnjordan110807@gmail.com</a>
                            </p>
