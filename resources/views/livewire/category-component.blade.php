                    ...
                    <div class="col-lg-9">
                        <div class="shop-product-fillter">
                            <div class="totall-product">
                                <p> We found <strong class="text-brand">{{$products->total()}}</strong> items for {{$category_name}} for you!</p>
                            </div>
                        ...
                        <div class="widget-category mb-30">
                            ...
                            <ul class="categories">
                                @foreach ($categories as $category)
                                    <li><a href="{{route('product.category', ['slug' => $category->slug])}}" style = "color: {{$category->name == $category_name ? '#F15412' : '#000000'}}">{{$category->name}}</a></li>
                                @endforeach
                            </ul>
                        </div>
                        <!-- Fillter By Price -->
