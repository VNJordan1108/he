<div>
    <style>
        .wishlisted
        {
            background-color: #f14142 !important;
                        ...
                        <div class="shop-product-fillter">
                            ...
                            <div class="sort-by-product-area">
                                <div class="sort-by-cover mr-10">
                                    <div class="sort-by-product-wrap">
                                        ...
                                        <div class="sort-by-dropdown-wrap">
                                            <span> {{$pageSize != $products->total() ? $pageSize : "All"}} <i class="fi-rs-angle-small-down"></i></span>
                                        </div>
                                    </div>
                                    <div class="sort-by-dropdown">
                                        <ul>
                                            ...
                                            <li><a class="{{$pageSize == $products->total() ? 'active':''}}" href="#" wire:click.prevent = "changePageSize({{$products->total()}})">All</a></li>
                                        </ul>
                                    </div>
                                </div>
                                <div class="sort-by-cover">
                                    ...
                                    <div class="sort-by-dropdown">
                                        <ul>
                                            <li><a class = "{{$orderBy == "Default" ? "active" : ""}}" href = "#" wire:click.prevent = "changeOrderBy('Default')">Default</a></li>
                                    ...
                                    <div class="product-img-action-wrap">
                                        <div class="product-img product-img-zoom">
                                            <a href="{{route('product.details',['slug'=>$product->slug])}}">
                                                ...
                                                <img class="hover-img" src="{{asset('assets/imgs/shop/product-')}}{{$product->id}}-2.jpg" alt="{{$product->name}}" title="{{$product->name}}">
                                            </a>
                                        </div>
                                    ...
                                    <div class="product-content-wrap">
                                        ...
                                        <div class="product-action-1 show">
                                            ...
                                            @else
                                                <a aria-label="Add To Wishlist" class="action-btn hover-up" href="#" wire:click.prevent = "addToWishlist({{$product->id}}, '{{$product->name}}', {{$product->regular_price}})"><i class="fi-rs-heart"></i></a>
                                            @endif
                                            <a aria-label="Add To Cart" class="action-btn hover-up" href="#" wire:click.prevent = "store({{$product->id}},'{{$product->name}}',{{ is_null($product->sale_price) == True ? $product->regular_price : $product->sale_price}})"><i class="fi-rs-shopping-bag-add"></i></a>
                                        </div>
                                    </div>
                                </div>
                            </div>
