                                            ...
                                            <tr>
                                                ...
                                                <td class="price" data-title="Price">
                                                    @if (is_null($item->model->sale_price))
                                                        ...
                                                        <?php Cart::update($item->rowId, ['price' => $item->model->regular_price]) ?>
                                                    @else
                                                        <span>${{$item->model->sale_price}}</span>
                                                        <span style="color: gray"><s>${{$item->model->regular_price}}</s></span>
                                                        <?php Cart::update($item->rowId, ['price' => $item->model->sale_price]) ?>
                                                    @endif
                                                </td>
                                                ...
                                                <td class="action" data-title="Remove"><div wire:click.prevent = "destroy('{{$item->rowId}}')" class="text-muted"><i class="fi-rs-trash"></i></div></td>
                                            </tr>
                                        @endforeach
                                        <tr>
                                            <td colspan="6" class="text-end">
                                                <a href="" wire:click.prevent = "clearAll()" class="text-muted"> <i class="fi-rs-cross-small"></i> Clear Cart</a>
                                            </td>
                                        </tr>
                                    </tbody>
