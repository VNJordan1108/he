                                ...
                                <div class="product-img-action-wrap">
                                    <div class="product-img product-img-zoom">
                                        <a href="{{route('product.details',['slug'=>$item->model->slug])}}">
                                            <img class="default-img" src="{{asset('assets/imgs/shop/product-')}}{{$item->model->id}}-1.jpg" alt="{{$item->model->name}}" title="{{$item->model->name}}">
                                            <img class="hover-img" src="{{asset('assets/imgs/shop/product-')}}{{$item->model->id}}-2.jpg" alt="{{$item->model->name}}" title="{{$item->model->name}}">
                                        </a>
                                    </div>
